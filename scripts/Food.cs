...
public partial class Food : Component
{
    public static List<FoodDefinition> FoodDefinitions = new()
    {
        ...
        new FoodDefinition(){Id = "Underwear2",            Name = "Underwear",            RequiredMouthSize = 99,  ConsumptionTime = 1  * 60,     StomachSpace = 18,  SellValue = 314,      Sprite = Assets.GetAsset<Texture>("food_items/Underwear.png") },
        new FoodDefinition(){Id = "Burger2",               Name = "Burger",               RequiredMouthSize = 122, ConsumptionTime = 3  * 60,     StomachSpace = 6,   SellValue = 628,      Sprite = Assets.GetAsset<Texture>("food_items/Burger.png") },
        new FoodDefinition(){Id = "Pizza2",                Name = "Pizza",                RequiredMouthSize = 108, ConsumptionTime = 10 * 60,     StomachSpace = 14,  SellValue = 942,      Sprite = Assets.GetAsset<Texture>("food_items/Pizza.png") },
        new FoodDefinition(){Id = "Popcorn2",              Name = "Popcorn",              RequiredMouthSize = 145, ConsumptionTime = 12 * 60,     StomachSpace = 22,  SellValue = 1256,     Sprite = Assets.GetAsset<Texture>("food_items/Popcorn.png") },
        new FoodDefinition(){Id = "Watermelon2",           Name = "Watermelon",           RequiredMouthSize = 152, ConsumptionTime = 17 * 60,     StomachSpace = 31,  SellValue = 1570,     Sprite = Assets.GetAsset<Texture>("food_items/Watermelon.png") },
        new FoodDefinition(){Id = "fire_hydrant_normal2",  Name = "fire_hydrant_normal",  RequiredMouthSize = 169, ConsumptionTime = 21 * 60,     StomachSpace = 44,  SellValue = 1884,     Sprite = Assets.GetAsset<Texture>("food_items/fire_hydrant_normal.png") },
        new FoodDefinition(){Id = "Potted_Tree2",          Name = "Potted_Tree",          RequiredMouthSize = 199, ConsumptionTime = 19 * 60,     StomachSpace = 71,  SellValue = 2198,     Sprite = Assets.GetAsset<Texture>("food_items/Potted_Tree.png") },
        new FoodDefinition(){Id = "Picnick_Table_Empty2",  Name = "Picnick_Table_Empty",  RequiredMouthSize = 227, ConsumptionTime = 30 * 60,     StomachSpace = 11,  SellValue = 2512,     Sprite = Assets.GetAsset<Texture>("food_items/Picnick_Table_Empty.png") },
        new FoodDefinition(){Id = "Garbage_Bins_Unclean2", Name = "Garbage_Bins_Unclean", RequiredMouthSize = 244, ConsumptionTime = 14 * 60,     StomachSpace = 93,  SellValue = 2826,     Sprite = Assets.GetAsset<Texture>("food_items/Garbage_Bins_Unclean.png") },

        new FoodDefinition(){Id = "Watermelon3",           Name = "Watermelon",           RequiredMouthSize = 250, ConsumptionTime = 5  * 60,     StomachSpace = 20,  SellValue = 51700,    Sprite = Assets.GetAsset<Texture>("food_items/Watermelon.png") },
        new FoodDefinition(){Id = "fire_hydrant_normal3",  Name = "fire_hydrant_normal",  RequiredMouthSize = 302, ConsumptionTime = 13 * 60,     StomachSpace = 26,  SellValue = 103400,   Sprite = Assets.GetAsset<Texture>("food_items/fire_hydrant_normal.png") },
        new FoodDefinition(){Id = "Potted_Tree3",          Name = "Potted_Tree",          RequiredMouthSize = 430, ConsumptionTime = 24 * 60,     StomachSpace = 12,  SellValue = 206800,   Sprite = Assets.GetAsset<Texture>("food_items/Potted_Tree.png") },
        new FoodDefinition(){Id = "Picnick_Table_Empty3",  Name = "Picnick_Table_Empty",  RequiredMouthSize = 333, ConsumptionTime = 19 * 60,     StomachSpace = 28,  SellValue = 413600,   Sprite = Assets.GetAsset<Texture>("food_items/Picnick_Table_Empty.png") },
        new FoodDefinition(){Id = "Garbage_Bins_Unclean3", Name = "Garbage_Bins_Unclean", RequiredMouthSize = 377, ConsumptionTime = 32 * 60,     StomachSpace = 54,  SellValue = 827200,   Sprite = Assets.GetAsset<Texture>("food_items/Garbage_Bins_Unclean.png") },
        new FoodDefinition(){Id = "Car3",                  Name = "Car",                  RequiredMouthSize = 420, ConsumptionTime = 45 * 60,     StomachSpace = 37,  SellValue = 1654400,  Sprite = Assets.GetAsset<Texture>("food_items/Car.png") },
        new FoodDefinition(){Id = "tesla3",                Name = "tesla",                RequiredMouthSize = 404, ConsumptionTime = 36 * 60,     StomachSpace = 46,  SellValue = 3308800,  Sprite = Assets.GetAsset<Texture>("food_items/tesla.png") },
        new FoodDefinition(){Id = "monster3",              Name = "monster",              RequiredMouthSize = 448, ConsumptionTime = 1 * 60 * 60, StomachSpace = 79,  SellValue = 6617600,  Sprite = Assets.GetAsset<Texture>("food_items/monster truck clean.png") },
        new FoodDefinition(){Id = "plane_clean3",          Name = "plane_clean",          RequiredMouthSize = 495, ConsumptionTime = 2 * 60 * 60, StomachSpace = 111, SellValue = 13235200, Sprite = Assets.GetAsset<Texture>("food_items/plane_clean.png") },
    };
